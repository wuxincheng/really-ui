...
public class DateUtil {
	...
	public static String formatDaily(String dailyDate) {
		if (!Validation.isDateCheck(dailyDate)) {
			return null;
		}
		
		String month = dailyDate.substring(4, 6);
		String daily = dailyDate.substring(6, 8);
		
		return month+"月"+daily+"日";
	}
	
	public static String formatDailyRev(String dailyDate) {
		String year = getCurrentDate(new Date(), "yyyy");
		return year+dailyDate.replace("月", "").replace("日", "");
	}
	
	public static void main(String[] args) throws Exception {
		System.out.println(formatDaily("20150406"));
		
		System.out.println(formatDailyRev("04月06日"));
	}
